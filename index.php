...
<body class="ltr app sidebar-mini light-mode">
                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-md-flex main-header-notification flag-dropdown">
                                            <a href="javascript:void(0);"
                                                class="nav-link icon text-center country-nav-link"
                                                ...
                                                <div class="message-menu ps2 overflow-hidden">
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            ...
                                                            style="background: url(_/assets/images/users/1.html) center center;"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            ...
                                                            style="background: url(_/assets/images/users/15.html) center center;">
                                                        </span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            ...
                                                            style="background: url(_/assets/images/users/12.html) center center;">
                                                        </span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span
                                                            ...
                                                            style="background: url(_/assets/images/users/4.html) center center;">
                                                        </span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                        ...
                                        <div class="dropdown d-md-flex profile-1">
                                            <a href="#" data-bs-toggle="dropdown"
                                                ...
                                                <div class="text-center p-1 d-flex d-lg-none-max">
                                                    <h6 class="mb-0 ms-1" id="profile-heading">Elena<i
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            ...
                                            <li><a class="sub-slide-item" href="file-manager-1.html">File Manager</a>
                                            </li>
                                            <li><a class="sub-slide-item" href="file-manager-2.html">File Details</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            ...
                                            <li><a class="sub-slide-item" href="mail-settings.html">Mail Settings</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            ...
                                            <li><a class="sub-slide-item" href="invoice-details.html">Invoice
                                                    Details</a></li>
                                            <li><a class="sub-slide-item" href="invoice-create.html">Create Invoice</a>
                                            </li>
                                    ...
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            ...
                                            <li><a class="sub-slide-item" href="projects-list.html">Projects List</a>
                                            </li>
    ...
    <div class="modal buynow buynow-btn ">
        <div class="modal-dialog modal-lg " role="document">
            <div class="modal-content modal-content-demo  cover-image"
                data-bs-image-src="../assets/switcher/img/16.jpg">
                    ...
                    <div class="row justify-content-center py-4 px-0 mx-3  Licenses-img">
                        ...
                        <div class="col-sm-10 col-md-8 col-xl-5 col-lg-5">
                            <div class="card  border-0 regular-license">
                                <div class="card-body imag-list cover-image"
                                    data-bs-image-src="../assets/switcher/img/14.jpg">
                                    <div class="text-white">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="fw-semi-bold mb-sm-2 mb-0">You <span
                                                    class="text-success font-weight-semibold">can't charge </span> from
                                                your <br><span class="op-8">End Product End Users</span> </p>
                                            <div class="dropdown">
                                                <button class="btn btn-info w-lg dropdown-toggle mt-1" type="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                    Buy Now
                                                </button>
                                                <div class="dropdown-menu py-0">
                                                    <a class="dropdown-item  border-bottom px-3" target="_blank"
                                                        href="https://1.envato.market/BX4yyB">
                                                        <div>
                                                            <p class="tx-14 mb-0 lh-xs font-weight-semibold">Buy Now</p>
                                                            <span class="tx-12 op-7 ">6 months support</span>
                                                        </div>
                                                    </a>
                                                    <a class="dropdown-item   px-3" target="_blank"
                                                        href="https://1.envato.market/jWvzo5">
                                                        <div>
                                                            <p class="tx-14 mb-0 lh-xs font-weight-semibold">Buy Now</p>
                        ...
                        <div class="col-sm-10 col-md-8 col-xl-5 col-lg-5">
                            <div class="card border-0 ">
                                <div class="card-body imag-list cover-image"
                                    data-bs-image-src="../assets/switcher/img/15.jpg">
                                    <div class="text-white">
                                        ...
                                        <div class="text-center">
                                            <div class="tx-26"><span class="font-weight-medium ">Extended</span>
                                                Licenses</div>
                                            <p class="fw-semi-bold mb-sm-2 mb-0">You <span
                                                    class="text-warning font-weight-semibold">can charge</span> from
                                                your <br><span class="op-8">End Product End Users</span></p>
                                            <div class="dropdown">
                                                <button class="btn btn-info w-lg dropdown-toggle mt-1" type="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                ...
                                                <div class="dropdown-menu py-0">
                                                    <a class="dropdown-item  border-bottom px-3" target="_blank"
                                                        href="https://1.envato.market/zaJbb0">
                                                        <div>
                                                            <p class="tx-14 mb-0 lh-xs font-weight-semibold">Buy Now</p>
                                                            <span class="tx-12 op-7 ">6 months support</span>
                                                        </div>
                                                    ...
                                                    <a class="dropdown-item   px-3" target="_blank"
                                                        href="https://1.envato.market/5bVA9L">
                                                        <div>
                                                            <p class="tx-14 mb-0 lh-xs font-weight-semibold">Buy Now</p>
                                                            <span class="tx-12 op-7 ">12 months support</span>
                                                        </div>
                        ...
                        <div class="license-view">
                            <a href="https://spruko.com/licenses" target="_blank"
                                class="modal-title text-center mb-3 tx-14 text-white">View license details</a>
                        </div>
                    </div>
                </div>
            </div>
